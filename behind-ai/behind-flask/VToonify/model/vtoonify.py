...
from VToonify.model.stylegan.model import ConvLayer, EqualLinear, Generator, ResBlock
from VToonify.model.dualstylegan import AdaptiveInstanceNorm, AdaResBlock, DualStyleGAN
